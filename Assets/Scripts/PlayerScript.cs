...
public class PlayerScript : MonoBehaviour
{
    ...
    bool invincible = false; //This determines of the player is invincible
    ...
    //PlayerMovement
    Vector2 movement; //This will be used to determine the players movement (x and y movement)
